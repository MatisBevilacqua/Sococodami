...
class getReplyRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ReplyRepository.php';

        return $container->privates['App\\Repository\\ReplyRepository'] = new \App\Repository\ReplyRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
