...
class __TwigTemplate_f71b0cb54f2e89c1abd72605a8a22c95 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "
\t<main>
\t\t<h1 class=\"news__title\">Questions récentes</h1>
...
\t\t\t\t\t<p>";
            // line 19
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_date_modify_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["comment"], "date", [], "any", false, false, false, 19), "Y-m-d H:i:s"), "+2 hours"), "Y-m-d H:i:s"), "html", null, true);
            echo " | ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["comment"], "user", [], "any", false, false, false, 19), "html", null, true);
            echo "</p>
\t\t\t\t\t<p></p>
\t\t\t\t\t<p>";
            // line 21
...
";
    ...
    {
        return array (  152 => 26,  142 => 22,  138 => 21,  131 => 19,  128 => 18,  124 => 17,  117 => 12,  107 => 11,  95 => 8,  90 => 7,  80 => 6,  60 => 3,  37 => 1,);
    }
...
\t\t\t\t\t<p>{{ comment.date|date('Y-m-d H:i:s')|date_modify('+2 hours')|date('Y-m-d H:i:s') }} | {{ comment.user }}</p>
\t\t\t\t\t<p></p>
\t\t\t\t\t<p>{{ comment.Title }}</p>
\t\t\t\t\t<p>{{ comment.content }}</p>
\t\t\t\t</li>
...
\t</main>
{% endblock %}
", "forum/index.html.twig", "/Applications/MAMP/htdocs/Pro/sococodami/templates/forum/index.html.twig");
    }
}
