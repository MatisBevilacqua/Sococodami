 ...
 */
class getVichUploader_Listener_Clean_NewsImageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.news_image' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.news_image'])) {
            return $container->privates['vich_uploader.listener.clean.news_image'];
        }

        return $container->privates['vich_uploader.listener.clean.news_image'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('news_image', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);
    }
}
